...
def build_result() -> SearchResult:
    ...
    return SearchResult(
        ...
        selected_stay_base_name=resort.stay_bases[0].name,
        selected_stay_base_lift_distance=resort.stay_bases[0].lift_distance,
        stay_base_price_range=resort.stay_bases[0].price_range,
        selected_area_name=resort.stay_bases[0].name,
        selected_area_lift_distance=resort.stay_bases[0].lift_distance,
        area_price_range=resort.stay_bases[0].price_range,
