...
| `stay_base:kitzbuhel-kitzbuhel` | `atmosphere_tags` | `[]` | `["premium", "apres_ski", "walkable_lifts"]` | `verified_with_adjustment` | no |
| `stay_base:kitzbuhel-kitzbuhel` | `base_type` | `null` | `"resort_town"` | `verified_with_adjustment` | no |
...
| `trust_manifest:ski_area_access:kitzbuhel-kitzbuhel--kitzbuhel-ski-area` | `source_refs` | `["https://www.bergfex.com/kitzbuehel-kirchberg/"]` | `["https://www.bergfex.com/kitzbuehel-kirchberg/", "https://www.kitzbuehel.com/en/activities/ski-resort/skiing/", "https://www.openstreetmap.org/node/1685958015", "https://www.openstreetmap.org/relation/85657", "https://www.openstreetmap.org/way/156335495"]` | `estimated` | no |
| `trust_manifest:ski_areas:kitzbuhel-ski-area` | `display_name` | `"Kitzbuhel"` | `"Kitzbühel"` | `estimated` | no |
| `trust_manifest:ski_areas:kitzbuhel-ski-area` | `field_statuses` | `{"elevation_season": "needs_source", "identity_coordinates": "needs_source", "skill_fit": "estimated", "terrain_metrics": "needs_source"}` | `{"elevation_season": "needs_source", "identity_coordinates": "verified_with_adjustment", "skill_fit": "estimated", "terrain_metrics": "verified_with_adjustment"}` | `estimated` | no |
| `trust_manifest:ski_areas:kitzbuhel-ski-area` | `source_refs` | `[]` | `["https://www.kitzbuehel.com/en/activities/ski-resort/skiing/"]` | `estimated` | no |
...
| `trust_manifest:ski_regions:kitzbuhel` | `source_refs` | `[]` | `["https://www.kitzbuehel.com/en/activities/ski-resort/skiing/"]` | `estimated` | no |
| `trust_manifest:stay_bases:kitzbuhel-kitzbuhel` | `display_name` | `"Kitzbuhel"` | `"Kitzbühel"` | `estimated` | no |
| `trust_manifest:stay_bases:kitzbuhel-kitzbuhel` | `field_statuses` | `{"atmosphere": "estimated", "coordinates": "needs_source", "identity_ownership": "needs_source", "lodging_price_quality": "estimated"}` | `{"atmosphere": "estimated", "coordinates": "verified_with_adjustment", "identity_ownership": "verified_with_adjustment", "lodging_price_quality": "estimated"}` | `estimated` | no |
| `trust_manifest:stay_bases:kitzbuhel-kitzbuhel` | `source_refs` | `[]` | `["https://www.kitzbuehel.com/en/activities/ski-resort/skiing/", "https://www.openstreetmap.org/relation/85657"]` | `estimated` | no |
| `trust_manifest:stay_destinations:kitzbuhel` | `display_name` | `"Kitzbuhel"` | `"Kitzbühel"` | `estimated` | no |
| `trust_manifest:stay_destinations:kitzbuhel` | `field_statuses` | `{"coordinates": "needs_source", "identity_location": "needs_source", "price_level_atmosphere": "estimated"}` | `{"coordinates": "needs_source", "identity_location": "verified_with_adjustment", "price_level_atmosphere": "estimated"}` | `estimated` | no |
| `trust_manifest:stay_destinations:kitzbuhel` | `source_refs` | `[]` | `["https://www.kitzbuehel.com/en/activities/ski-resort/skiing/"]` | `estimated` | no |
...
| `stay_base:kitzbuhel-kitzbuhel` | `atmosphere_tags` | `changed` |  |
...
| `stay_destination:kitzbuhel` | `atmosphere_tags` | `reviewed-no-change` |  |
...
| `trust_manifest:lift_pass_products:kitzski-skipass` | `source_refs` | `changed` |  |
...
| `trust_manifest:ski_area_access:kitzbuhel-kitzbuhel--kitzbuhel-ski-area` | `source_refs` | `changed` |  |
...
| `trust_manifest:ski_areas:kitzbuhel-ski-area` | `source_refs` | `changed` |  |
...
| `trust_manifest:ski_regions:kitzbuhel` | `source_refs` | `changed` |  |
...
| `trust_manifest:stay_bases:kitzbuhel-kitzbuhel` | `source_refs` | `changed` |  |
...
| `trust_manifest:stay_destinations:kitzbuhel` | `source_refs` | `changed` |  |
...
| `stay_base:kitzbuhel-kitzbuhel` | `atmosphere_tags` | [Skiing in Kitzbühel](https://www.kitzbuehel.com/en/activities/ski-resort/skiing/) | `["premium", "apres_ski", "walkable_lifts"]` | Official page emphasizes iconic skiing, mountain hospitality, direct town lift access, and Kitzbühel's premium resort-town identity. |  |
