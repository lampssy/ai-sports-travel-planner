...
| `stay_base:solden-solden` | `atmosphere_tags` | `[]` | `["sporty", "glacier_skiing", "walkable_lifts"]` | `verified_with_adjustment` | no |
| `stay_base:solden-solden` | `base_type` | `null` | `"resort_village"` | `verified_with_adjustment` | no |
...
| `trust_manifest:lift_pass_products:otztal-super-skipass` | `source_refs` | `null` | `["https://www.openstreetmap.org/relation/77772", "https://www.openstreetmap.org/way/29330800", "https://www.openstreetmap.org/way/92100602", "https://www.soelden.com/en/activities/winter/skiing-snowboarding", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices/faq-refund", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices/winter", "https://www.soelden.com/en/region-villages/soelden-a-z/giggijochbahn.i-93ccf5ab-f1a1-43bb-a48b-fe0198cf5423", "https://www.soelden.com/en/region-villages/soelden-a-z/grizzley-sports.i-5dfbcae7-c289-4786-a410-8910af0c2403", "https://www.soelden.com/en/search-book/ski-mountain-lift-tickets/ticket-overview/3-days-otztal.lt-209052", "https://www.soelden.com/en/search-book/ski-mountain-lift-tickets/ticket-overview/6-days-otztal.lt-209064"]` | `estimated` | no |
...
| `trust_manifest:lift_pass_products:solden-skipass` | `source_refs` | `null` | `["https://www.openstreetmap.org/relation/77772", "https://www.openstreetmap.org/way/29330800", "https://www.openstreetmap.org/way/92100602", "https://www.soelden.com/en/activities/winter/skiing-snowboarding", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices/faq-refund", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices/winter", "https://www.soelden.com/en/region-villages/soelden-a-z/giggijochbahn.i-93ccf5ab-f1a1-43bb-a48b-fe0198cf5423", "https://www.soelden.com/en/region-villages/soelden-a-z/grizzley-sports.i-5dfbcae7-c289-4786-a410-8910af0c2403", "https://www.soelden.com/en/search-book/ski-mountain-lift-tickets/ticket-overview/3-days-otztal.lt-209052", "https://www.soelden.com/en/search-book/ski-mountain-lift-tickets/ticket-overview/6-days-otztal.lt-209064"]` | `estimated` | no |
...
| `trust_manifest:ski_area_access:solden-solden--solden-ski-area` | `source_refs` | `["https://www.bergfex.com/soelden/"]` | `["https://www.bergfex.com/soelden/", "https://www.openstreetmap.org/relation/77772", "https://www.openstreetmap.org/way/92100602", "https://www.soelden.com/en/region-villages/soelden-a-z/giggijochbahn.i-93ccf5ab-f1a1-43bb-a48b-fe0198cf5423"]` | `estimated` | no |
| `trust_manifest:ski_areas:solden-ski-area` | `display_name` | `"Solden"` | `"Sölden"` | `estimated` | no |
| `trust_manifest:ski_areas:solden-ski-area` | `field_statuses` | `{"elevation_season": "needs_source", "identity_coordinates": "needs_source", "skill_fit": "estimated", "terrain_metrics": "needs_source"}` | `{"elevation_season": "verified_with_adjustment", "identity_coordinates": "verified_with_adjustment", "skill_fit": "estimated", "terrain_metrics": "verified_with_adjustment"}` | `estimated` | no |
| `trust_manifest:ski_areas:solden-ski-area` | `source_refs` | `[]` | `["https://www.soelden.com/en/activities/winter/skiing-snowboarding", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices", "https://www.soelden.com/en/activities/winter/skiing-snowboarding/skipasses-prices/faq-refund"]` | `estimated` | no |
...
| `trust_manifest:ski_regions:solden` | `source_refs` | `[]` | `["https://www.soelden.com/en/activities/winter/skiing-snowboarding"]` | `estimated` | no |
| `trust_manifest:stay_bases:solden-solden` | `display_name` | `"Solden"` | `"Sölden"` | `estimated` | no |
| `trust_manifest:stay_bases:solden-solden` | `field_statuses` | `{"atmosphere": "estimated", "coordinates": "needs_source", "identity_ownership": "needs_source", "lodging_price_quality": "estimated"}` | `{"atmosphere": "estimated", "coordinates": "verified_with_adjustment", "identity_ownership": "verified_with_adjustment", "lodging_price_quality": "estimated"}` | `estimated` | no |
| `trust_manifest:stay_bases:solden-solden` | `source_refs` | `[]` | `["https://www.openstreetmap.org/relation/77772", "https://www.soelden.com/en/activities/winter/skiing-snowboarding"]` | `estimated` | no |
| `trust_manifest:stay_destinations:solden` | `display_name` | `"Solden"` | `"Sölden"` | `estimated` | no |
| `trust_manifest:stay_destinations:solden` | `field_statuses` | `{"coordinates": "needs_source", "identity_location": "needs_source", "price_level_atmosphere": "estimated"}` | `{"coordinates": "needs_source", "identity_location": "verified_with_adjustment", "price_level_atmosphere": "estimated"}` | `estimated` | no |
| `trust_manifest:stay_destinations:solden` | `source_refs` | `[]` | `["https://www.soelden.com/en/activities/winter/skiing-snowboarding"]` | `estimated` | no |
...
| `stay_base:solden-solden` | `atmosphere_tags` | `changed` |  |
...
| `stay_destination:solden` | `atmosphere_tags` | `reviewed-no-change` |  |
...
| `trust_manifest:lift_pass_products:otztal-super-skipass` | `source_refs` | `changed` |  |
...
| `trust_manifest:lift_pass_products:solden-skipass` | `source_refs` | `changed` |  |
...
| `trust_manifest:ski_area_access:solden-solden--solden-ski-area` | `source_refs` | `changed` |  |
...
| `trust_manifest:ski_areas:solden-ski-area` | `source_refs` | `changed` |  |
...
| `trust_manifest:ski_regions:solden` | `source_refs` | `changed` |  |
...
| `trust_manifest:stay_bases:solden-solden` | `source_refs` | `changed` |  |
...
| `trust_manifest:stay_destinations:solden` | `source_refs` | `changed` |  |
...
| `stay_base:solden-solden` | `atmosphere_tags` | [Sölden ski area](https://www.soelden.com/en/activities/winter/skiing-snowboarding) | `["sporty", "glacier_skiing", "walkable_lifts"]` | Official page emphasizes mountain sport, two glaciers, and village lift access. |  |
