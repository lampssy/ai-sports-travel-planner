...
Retains one Alta Badia stay market, adds source-backed bases and transfer-required Lagazuoi, keeps La Crusc and official sectors under the parent, and defers foreign regional topology.
...
flowchart LR
  ...
  base_2 -->|"access: walk via La Crusc"| area_1
  base_3 -->|"access: walk via Colfosco gondola"| area_1
  base_4 -->|"access: walk via Boè, 214 m"| area_1
  base_5 -->|"access: walk via Piz La Ila"| area_1
  base_6 -->|"access: walk via Piz Sorega"| area_1
...
| `alta-badia-skipass` (Alta Badia Ski Pass) | `lift_pass_product` | `represented` | `official_product_identity` | `lift_pass_product:alta-badia-skipass` | `scope-local-pass`, `scope-skiresort` |  | Local single-area product remains limited to the core. |
...
| `lagazuoi-ski-area` | `alta-badia-ski-area` | `complete` | `transfer_required` | `independent` | `parent_owned` | `limited` | `mixed` | `material` | `scope-lagazuoi`, `scope-lag-piste`, `scope-route` |
...
| --- | --- | --- | --- | --- | --- |
| `lift_pass_product:alta-badia-skipass` | `external_validity_summary` | `"Local Alta Badia pass covers the modeled 130 km Alta Badia ski area; broader Dolomiti Superski and Sellaronda access is available through separate regional products and is not copied into this local ski-area record."` | `"The local Alta Badia pass covers the modeled 130 km Alta Badia core. Lagazuoi, Dolomiti Superski, and Sellaronda coverage are not inferred into this product from route or regional-network context."` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-badia--alta-badia-ski-area` | `regional_data_ids` | `null` | `{}` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-badia--alta-badia-ski-area` | `source_urls` | `null` | `["https://www.altabadia.org/en/poi/what-to-do-in-alta-badia/detail/poi/skiing-in-the-la-crusc-santa-croce-area", "https://www.altabadia.org/en/villages/badia-alta-badia"]` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-colfosco--alta-badia-ski-area` | `regional_data_ids` | `null` | `{}` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-colfosco--alta-badia-ski-area` | `source_urls` | `null` | `["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/colfosco-alta-badia"]` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-la-villa--alta-badia-ski-area` | `regional_data_ids` | `null` | `{}` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-la-villa--alta-badia-ski-area` | `source_urls` | `null` | `["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/la-villa-alta-badia"]` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-san-cassiano--alta-badia-ski-area` | `regional_data_ids` | `null` | `{}` | `verified_with_adjustment` | no |
...
| `ski_area_access:alta-badia-san-cassiano--alta-badia-ski-area` | `source_urls` | `null` | `["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/san-cassiano-alta-badia"]` | `verified_with_adjustment` | no |
...
| `trust_manifest:ski_area_access:alta-badia-badia--alta-badia-ski-area` | `field_source_refs` | `null` | `{"access_mode_distance": ["https://www.altabadia.org/en/poi/what-to-do-in-alta-badia/detail/poi/skiing-in-the-la-crusc-santa-croce-area", "https://www.altabadia.org/en/villages/badia-alta-badia"], "relationship": ["https://www.altabadia.org/en/poi/what-to-do-in-alta-badia/detail/poi/skiing-in-the-la-crusc-santa-croce-area", "https://www.altabadia.org/en/villages/badia-alta-badia"]}` | `estimated` | no |
...
| `trust_manifest:ski_area_access:alta-badia-badia--alta-badia-ski-area` | `notes` | `null` | `["Official route material establishes a transfer relationship via bus/shuttle and cable car; is_direct=false prevents it being presented as lift-at-base access.", "No numeric distance or duration is stored where the accepted source does not establish one."]` | `estimated` | no |
...
| `trust_manifest:ski_area_access:alta-badia-colfosco--alta-badia-ski-area` | `notes` | `null` | `["Official route material establishes a transfer relationship via bus/shuttle and cable car; is_direct=false prevents it being presented as lift-at-base access.", "No numeric distance or duration is stored where the accepted source does not establish one."]` | `estimated` | no |
| `trust_manifest:ski_area_access:alta-badia-corvara--alta-badia-ski-area` | `notes` | `["Official Alta Badia sources confirm the local Alta Badia ski-area scope, 130 km of slopes, 53 lifts, the 2026/27 season window, and Alta Badia pass identity.", "Reviewed editorial evidence supplies the static difficulty split, summit elevation, and adult day-ticket price example where official static tables were not available.", "Stay-base lift access is source-backed with OSM Corvara and Boè lift-station geometry; lodging price, quality, supported-skill, and rental price fields remain product-curated estimates."]` | `["Official route material establishes a transfer relationship via bus/shuttle and cable car; is_direct=false prevents it being presented as lift-at-base access.", "No numeric distance or duration is stored where the accepted source does not establish one."]` | `estimated` | no |
...
| `trust_manifest:ski_area_access:alta-badia-la-villa--alta-badia-ski-area` | `field_source_refs` | `null` | `{"access_mode_distance": ["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/la-villa-alta-badia"], "relationship": ["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/la-villa-alta-badia"]}` | `estimated` | no |
...
| `trust_manifest:ski_area_access:alta-badia-la-villa--alta-badia-ski-area` | `notes` | `null` | `["Official route material establishes a transfer relationship via bus/shuttle and cable car; is_direct=false prevents it being presented as lift-at-base access.", "No numeric distance or duration is stored where the accepted source does not establish one."]` | `estimated` | no |
...
| `trust_manifest:ski_area_access:alta-badia-san-cassiano--alta-badia-ski-area` | `field_source_refs` | `null` | `{"access_mode_distance": ["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/san-cassiano-alta-badia"], "relationship": ["https://www.altabadia.org/en/skiing-alta-badia-dolomites", "https://www.altabadia.org/en/villages/san-cassiano-alta-badia"]}` | `estimated` | no |
...
| `trust_manifest:ski_area_access:alta-badia-san-cassiano--alta-badia-ski-area` | `notes` | `null` | `["Official route material establishes a transfer relationship via bus/shuttle and cable car; is_direct=false prevents it being presented as lift-at-base access.", "No numeric distance or duration is stored where the accepted source does not establish one."]` | `estimated` | no |
...
| `trust_manifest:ski_areas:lagazuoi-ski-area` | `notes` | `null` | `["Lagazuoi has a complete lift-served area and independent operating presentation and is transfer-required from the Alta Badia core.", "The catalog uses the lower cable-car station geometry, 2105 m pass/base elevation, and 2732 m lift-served upper station; it does not use the 2778 m mountain peak as child weather geometry.", "Aggregate terrain, local pass coverage, and terrain-domain membership are not inferred.", "The new ski-area ID is handed to scheduled historical-weather completion after merge."]` | `estimated` | no |
...
| `ski_area:alta-badia-ski-area` | `piste_km_by_difficulty.advanced` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
| `ski_area:alta-badia-ski-area` | `piste_km_by_difficulty.beginner` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
| `ski_area:alta-badia-ski-area` | `piste_km_by_difficulty.intermediate` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
...
| `ski_area:alta-badia-ski-area` | `total_lift_count` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
| `ski_area:alta-badia-ski-area` | `total_piste_km` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
...
| `ski_area_access:alta-badia-colfosco--alta-badia-ski-area` | `distance_m` | `unresolved` | No verification-capable evidence established a more specific value. |
...
| `ski_area_access:alta-badia-la-villa--alta-badia-ski-area` | `distance_m` | `unresolved` | No verification-capable evidence established a more specific value. |
...
| `ski_area_access:alta-badia-san-cassiano--alta-badia-ski-area` | `distance_m` | `unresolved` | No verification-capable evidence established a more specific value. |
...
| `ski_area_access:alta-badia-badia--alta-badia-ski-area` | `distance_m` | `unresolved` | No verification-capable evidence established a more specific value. |
...
| `lift_pass_product:alta-badia-skipass` | `pass_accessible_terrain` | `unresolved` | No verification-capable evidence established a more specific value. |
...
| `lift_pass_product:alta-badia-skipass` | `valid_ski_area_ids` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
| `lift_pass_product:alta-badia-skipass` | `validity_scope` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
...
| `trust_manifest:lift_pass_products:alta-badia-skipass` | `field_statuses` | `reviewed-no-change` | Reviewed against the complete candidate/source inventory; retained unchanged. |
...
| --- | --- | --- | --- | --- | --- |
| `lift_pass_product:alta-badia-skipass` | `external_validity_summary` | [Direct reviewed source](https://www.altabadia.org/en/alta-badia-skipass-prices/skipass-dolomites) | `"The local Alta Badia pass covers the modeled 130 km Alta Badia core. Lagazuoi, Dolomiti Superski, and Sellaronda coverage are not inferred into this product from route or regional-network context."` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
...
| `ski_area:alta-badia-ski-area` | `summit_elevation_m` | [Direct reviewed source](https://www.altabadia.org/en/ski-area-alta-badia-dolomites) | `2550` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
| `ski_area:lagazuoi-ski-area` | `base_elevation_m` | [Direct reviewed source](https://lagazuoi.it/EN/Experience-Winter-page7-Lagazuoi-Ski-Area) | `2105` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
| `ski_area:lagazuoi-ski-area` | `latitude` | [Direct reviewed source](https://lagazuoi.it/EN/Experience-Winter-page7-Lagazuoi-Ski-Area) | `46.5191116` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
| `ski_area:lagazuoi-ski-area` | `longitude` | [Direct reviewed source](https://lagazuoi.it/EN/Experience-Winter-page7-Lagazuoi-Ski-Area) | `12.008447` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
...
| `ski_area:lagazuoi-ski-area` | `season_end_month` | [Direct reviewed source](https://lagazuoi.it/EN/Experience-Winter-page7-Lagazuoi-Ski-Area) | `4` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
| `ski_area:lagazuoi-ski-area` | `season_start_month` | [Direct reviewed source](https://lagazuoi.it/EN/Experience-Winter-page7-Lagazuoi-Ski-Area) | `12` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
| `ski_area:lagazuoi-ski-area` | `season_windows` | [Direct reviewed source](https://lagazuoi.it/EN/Experience-Winter-page7-Lagazuoi-Ski-Area) | `[]` | The direct source supports the normalized field and its owner scope. | Normalized into the Snowcast catalog/trust contract. |
...
| `ski_area:alta-badia-ski-area` | `name` | [Alta Badia piste map](https://www.altabadia.org/fileadmin/user_upload/Documenti/Dolomiti_Superski/CARTINA_DSS_Alta_Badia_2025-2026_.pdf) | `"Alta Badia"` | Core sectors and representative geometry. |  |
...
| `ski_area:alta-badia-ski-area` | `name` | [Alta Badia ski area](https://www.altabadia.org/en/ski-area-alta-badia-dolomites) | `"Alta Badia"` | Core scope and 53-lift product count. |  |
...
| `lift_pass_product:alta-badia-skipass` | `name` | [Alta Badia local pass](https://www.altabadia.org/en/alta-badia-skipass-prices/skipass-dolomites) | `"Alta Badia Ski Pass"` | Core local product. |  |
| `lift_pass_product:alta-badia-skipass` | `external_validity_summary` | [Dolomiti Superski pricing](https://www.dolomitisuperski.com/en/plan-and-book/skipassandprices/alta-badia) | `"The local Alta Badia pass covers the modeled 130 km Alta Badia core. Lagazuoi, Dolomiti Superski, and Sellaronda coverage are not inferred into this product from route or regional-network context."` | Regional product context. |  |
| `lift_pass_product:alta-badia-skipass` | `external_validity_summary` | [Alta Badia points card](https://www.altabadia.org/fileadmin/user_upload/Documenti/Dolomiti_Superski/DSski_Tessera_valore_2025_26_Alta_Badia.pdf) | `"The local Alta Badia pass covers the modeled 130 km Alta Badia core. Lagazuoi, Dolomiti Superski, and Sellaronda coverage are not inferred into this product from route or regional-network context."` | Stale discovery-only product document. |  |
...
Explicit bases/access improve stay-base evidence; separate Lagazuoi prevents parent weather attribution; the local pass remains core-only. Inherited lodging tuples remain estimated.
...
- No Alta Badia–Lagazuoi terrain domain or Lagazuoi local-pass coverage is inferred. Cortina/Cinque Torri topology is deferred without changing Cortina internals.
...
- Official scope pages support 53 lifts while live inventory can enumerate 54; 53 remains the catalog scope with the distinction recorded.
