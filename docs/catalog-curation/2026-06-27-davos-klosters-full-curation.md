...
| `lift_pass_product:schatzalp-strela-ski-pass` | `prices` | `null` | `[{"amount": null, "amount_max": 43.0, "amount_min": 36.0, "audience": "adult", "currency": "CHF", "duration_days": 1, "price_kind": "range", "season_label": "Winter 2026/27 weekday-to-weekend", "source_url": "https://www.schatzalp.ch/download/WinterFolder.pdf"}]` | `verified` | no |
...
| `ski_area:schatzalp-strela` | `base_elevation_m` | `null` | `1861` | `verified_with_adjustment` | yes |
...
| `ski_area:schatzalp-strela` | `official_trail_map.season_label` | `null` | `"Winter 2026/27"` | `verified` | no |
| `ski_area:schatzalp-strela` | `official_trail_map.url` | `null` | `"https://www.schatzalp.ch/download/WinterFolder.pdf"` | `verified` | no |
...
| `ski_area:schatzalp-strela` | `season_windows` | `null` | `[{"end_date": "2027-01-17", "season_label": "Winter 2026/27 before WEF closure", "start_date": "2026-12-19", "status": "planned"}, {"end_date": "2027-03-21", "season_label": "Winter 2026/27 after WEF closure", "start_date": "2027-01-23", "status": "planned"}]` | `verified_with_adjustment` | yes |
...
| `ski_area:schatzalp-strela` | `summit_elevation_m` | `null` | `2353` | `verified_with_adjustment` | yes |
| `ski_area:schatzalp-strela` | `supported_skill_levels` | `null` | `["beginner", "intermediate"]` | `verified_with_adjustment` | yes |
| `ski_area:schatzalp-strela` | `total_lift_count` | `null` | `4` | `verified_with_adjustment` | yes |
...
| `ski_area_access:klosters-platz--parsenn-gotschna` | `distance_m` | `null` | `153` | `verified_with_adjustment` | yes |
...
| `ski_area_access:klosters-platz--parsenn-gotschna` | `regional_data_ids` | `null` | `{"nearest_lift_osm_node_id": "281557004"}` | `verified_with_adjustment` | no |
...
| `ski_area_access:klosters-platz--parsenn-gotschna` | `source_urls` | `null` | `["https://www.davosklostersmountains.ch/en/mountains/mountains/parsenn", "https://www.openstreetmap.org/node/281557004"]` | `verified` | no |
...
| `trust_manifest:lift_pass_products:schatzalp-strela-ski-pass` | `field_source_refs` | `null` | `{"coverage": ["https://www.schatzalp.ch/download/WinterFolder.pdf"], "identity_scope_availability": ["https://www.schatzalp.ch/en/agb", "https://www.schatzalp.ch/en/funicular"], "pass_accessible_terrain": [], "prices": ["https://www.schatzalp.ch/download/WinterFolder.pdf"]}` | `estimated` | no |
| `trust_manifest:lift_pass_products:schatzalp-strela-ski-pass` | `field_statuses` | `null` | `{"coverage": "verified", "identity_scope_availability": "verified_with_adjustment", "pass_accessible_terrain": "needs_source", "prices": "verified"}` | `estimated` | no |
| `trust_manifest:lift_pass_products:schatzalp-strela-ski-pass` | `notes` | `null` | `["Official operator terms establish a separate ticket product for the Schatzalp funicular and ski-area facilities.", "The official winter map states that Davos Klosters Mountains passes are not valid in the private Schatzalp / Strela area.", "The Winter 2026/27 one-day adult range captures the published CHF 36 weekday and CHF 43 weekend/holiday prices; no exact pass terrain aggregate was accepted."]` | `estimated` | no |
...
| `trust_manifest:ski_area_access:klosters-platz--parsenn-gotschna` | `field_source_refs` | `null` | `{"access_mode_distance": ["https://www.davosklostersmountains.ch/en/mountains/mountains/parsenn", "https://www.openstreetmap.org/node/281557004"], "relationship": ["https://www.davosklostersmountains.ch/en/mountains/mountains/parsenn", "https://www.openstreetmap.org/node/281557004"]}` | `estimated` | no |
...
| `trust_manifest:ski_area_access:klosters-platz--parsenn-gotschna` | `notes` | `null` | `["The official area page identifies the Gotschna cable car as the Klosters feeder to the connected Parsenn / Gotschna area.", "The 153 m distance is the rounded Haversine distance from the reviewed Klosters Platz base point to OSM aerialway station node 281557004; no walking duration is inferred from straight-line geometry."]` | `estimated` | no |
...
| `trust_manifest:ski_areas:schatzalp-strela` | `field_source_refs` | `null` | `{"elevation_season": ["https://www.schatzalp.ch/download/WinterFolder.pdf", "https://www.schatzalp.ch/en/funicular", "https://www.schatzalp.ch/en/restaurants"], "glacier_terrain": [], "identity_coordinates": ["https://www.davos.ch/en/discover/mountains-in-davos-klosters/schatzalp-strela", "https://www.openstreetmap.org/node/2894011356"], "marked_freeride_routes": [], "night_skiing": [], "official_documents": ["https://www.schatzalp.ch/download/WinterFolder.pdf"], "ski_day_apres": [], "skill_fit": ["https://www.davos.ch/en/discover/mountains-in-davos-klosters/schatzalp-strela"], "snow_park": [], "snowmaking": ["https://www.davos.ch/en/discover/mountains-in-davos-klosters/schatzalp-strela"], "terrain_metrics": ["https://www.schatzalp.ch/download/WinterFolder.pdf"]}` | `estimated` | no |
...
| `ski_area:schatzalp-strela` | `official_trail_map.season_label` | `changed` |  |
...
| `ski_area:schatzalp-strela` | `total_lift_count` | `changed` |  |
...
| `ski_area_access:klosters-platz--parsenn-gotschna` | `distance_m` | `changed` |  |
| `ski_area_access:klosters-platz--parsenn-gotschna` | `duration_minutes` | `unresolved` | No routing or timetable source establishes a walking duration; it is not inferred from straight-line distance. |
...
| `ski_region:davos-klosters` | `parent_ski_region_id` | `not-applicable` | Davos Klosters is the root trip-market ski region; no parent region is intended. |
...
| `stay_base:davos-dorf` | `local_apres_profile.intensity` | `unresolved` | Official nightlife evidence is destination-wide and does not establish the breadth or intensity of a Davos Dorf-local apres scene. |
| `stay_base:davos-dorf` | `local_apres_profile.season_label` | `unresolved` | No accepted source establishes a Davos Dorf-local apres season label. |
...
| `ski_area:schatzalp-strela` | `base_elevation_m` | [schatzalp.ch source](https://www.schatzalp.ch/en/funicular) | `1861` | The official funicular page identifies Schatzalp, where the ski terrain begins, at 1,861 m; the 1,557 m value is the feeder station in Davos Platz. | The catalog value is normalized to Snowcast ownership, identifiers, enums, and units; it is not a verbatim transcription. |
...
| `ski_area:schatzalp-strela` | `official_trail_map.url` | [Schatzalp Winter 2026/27 brochure and trail map](https://www.schatzalp.ch/download/WinterFolder.pdf) | `"https://www.schatzalp.ch/download/WinterFolder.pdf"` | The current official Winter 2026/27 brochure contains the Schatzalp / Strela trail map. | The catalog value is normalized to Snowcast ownership, identifiers, enums, and units; it is not a verbatim transcription. |
...
| `ski_area:schatzalp-strela` | `season_windows` | [Schatzalp Winter 2026/27 brochure](https://www.schatzalp.ch/download/WinterFolder.pdf) | `[{"end_date": "2027-01-17", "season_label": "Winter 2026/27 before WEF closure", "start_date": "2026-12-19", "status": "planned"}, {"end_date": "2027-03-21", "season_label": "Winter 2026/27 after WEF closure", "start_date": "2027-01-23", "status": "planned"}]` | The operator brochure publishes ski-area operation from 19 December 2026 through 21 March 2027 and a WEF closure from 18 through 22 January 2027. | The published closure is normalized into two non-overlapping operating windows. |
...
| `ski_area:schatzalp-strela` | `summit_elevation_m` | [Schatzalp restaurants and Strela Pass](https://www.schatzalp.ch/en/restaurants) | `2353` | The official operator page places Strela Pass at 2,353 m. | The catalog value is normalized to Snowcast ownership, identifiers, enums, and units; it is not a verbatim transcription. |
...
| `ski_area_access:klosters-platz--parsenn-gotschna` | `regional_data_ids` | [OpenStreetMap Gotschnabahn station node](https://www.openstreetmap.org/node/281557004) | `{"nearest_lift_osm_node_id": "281557004"}` | The reviewed OSM aerialway-station node identifies the Gotschnabahn access point at Klosters Platz. | The catalog value is normalized to Snowcast ownership, identifiers, enums, and units; it is not a verbatim transcription. |
...
| `ski_area:schatzalp-strela` | `total_lift_count` | [Schatzalp Winter 2026/27 brochure](https://www.schatzalp.ch/download/WinterFolder.pdf) | `4` | The operator brochure identifies the funicular, historic chairlift, main drag lift, and Strela Junior drag lift. | The four named transport facilities are normalized to the ski-area lift count, including the feeder funicular. |
| `ski_area:schatzalp-strela` | `official_trail_map.season_label` | [Schatzalp Winter 2026/27 brochure and trail map](https://www.schatzalp.ch/download/WinterFolder.pdf) | `"Winter 2026/27"` | The official brochure labels the map for Winter 2026/27. |  |
| `lift_pass_product:schatzalp-strela-ski-pass` | `prices` | [Schatzalp Winter 2026/27 brochure](https://www.schatzalp.ch/download/WinterFolder.pdf) | `[{"amount": null, "amount_max": 43.0, "amount_min": 36.0, "audience": "adult", "currency": "CHF", "duration_days": 1, "price_kind": "range", "season_label": "Winter 2026/27 weekday-to-weekend", "source_url": "https://www.schatzalp.ch/download/WinterFolder.pdf"}]` | The Winter 2026/27 operator brochure publishes adult full-day prices of CHF 36 on weekdays and CHF 43 on weekends and the Christmas/New Year holiday period. | The two published day-price bands are represented as one adult one-day CHF 36-43 range. |
| `ski_area_access:klosters-platz--parsenn-gotschna` | `distance_m` | [OpenStreetMap Gotschnabahn station node](https://www.openstreetmap.org/node/281557004) | `153` | The reviewed OSM aerialway-station geometry supports the metric proximity of Klosters Platz to the Gotschnabahn. | 153 m is the rounded Haversine distance between the catalog base coordinate and OSM node 281557004; it is not a routed walking distance. |
| `ski_area_access:klosters-platz--parsenn-gotschna` | `source_urls` | [OpenStreetMap Gotschnabahn station node](https://www.openstreetmap.org/node/281557004) | `"https://www.openstreetmap.org/node/281557004"` | The OSM node is retained as the reproducible geometry source for the access distance. | The source URL is appended to the existing official-area source list. |
...
- Schatzalp / Strela Winter 2026/27 operating windows, lift count and representative one-day prices are captured from the current operator brochure; the exact piste total and difficulty split remain unresolved.
