...
| `trust_manifest:stay_bases:saalbach-hinterglemm-saalbach` | `field_source_refs` | `{"base_character": [], "base_type": [], "coordinates": [], "elevation": [], "identity_ownership": [], "local_apres": [], "lodging_price_quality": []}` | `{"base_character": [], "base_type": [], "coordinates": ["https://www.openstreetmap.org/node/240047212", "https://www.saalbach.com/en/winter/ski-resort"], "elevation": [], "identity_ownership": ["https://www.openstreetmap.org/node/240047212", "https://www.saalbach.com/en/winter/ski-resort"], "local_apres": [], "lodging_price_quality": ["https://www.openstreetmap.org/node/240047212", "https://www.saalbach.com/en/winter/ski-resort"]}` | `estimated` | no |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `glacier_terrain.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.route_count` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `name` | `reviewed-no-change` |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `night_skiing.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `night_skiing.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `official_trail_map.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `official_trail_map.url` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.intensity` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.park_count` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_basis` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_pct` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
...
| `stay_base:saalbach-hinterglemm-saalbach` | `base_character.development_style` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `stay_base:saalbach-hinterglemm-saalbach` | `base_character.local_pace` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `stay_base:saalbach-hinterglemm-saalbach` | `base_type` | `changed` |  |
| `stay_base:saalbach-hinterglemm-saalbach` | `elevation_m` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `stay_base:saalbach-hinterglemm-saalbach` | `latitude` | `changed` |  |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.availability` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.intensity` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.season_label` | `unresolved` | Version-2-only fields were not assessed by the original version-1 curation and require source-backed follow-up. |
