...
Migrates PR #15 onto the normalized Snowcast catalog. Facts are assigned to explicit regions, stay destinations, stay bases, ski areas, access edges, terrain domains, pass products, and rental facts. Source-aware v2 enrichment follow-up: Reviewed Saalbach and Skicircus facts against official operator and destination sources. Added published 90% snowmaking coverage, four freestyle parks, floodlit night skiing, marked ski-route availability, official piste map, destination-defining apres, base elevation, mixed character, lively pace, and local apres while retaining unsupported glacier terrain and route count as unknown.
...
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.availability` | `"unknown"` | `"available"` | `verified` | no |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `official_trail_map.url` | `null` | `"https://www.saalbach.com/en/winter/ski-resort/piste-map"` | `verified` | no |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.availability` | `"unknown"` | `"available"` | `verified` | no |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.park_count` | `null` | `4` | `verified` | no |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.availability` | `"unknown"` | `"available"` | `verified` | no |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_basis` | `"unknown"` | `"piste_length"` | `verified_with_adjustment` | no |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_pct` | `null` | `90.0` | `verified` | no |
...
| `stay_base:saalbach-hinterglemm-saalbach` | `elevation_m` | `null` | `1003` | `verified` | no |
| `stay_base:saalbach-hinterglemm-saalbach` | `latitude` | `null` | `47.3915` | `verified_with_adjustment` | no |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.availability` | `"unknown"` | `"available"` | `verified` | no |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `glacier_terrain.availability` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.availability` | `changed` | The official ski-resort page explicitly describes numerous ski routes of different difficulties. |
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.route_count` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.season_label` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
| `ski_area:saalbach-hinterglemm-ski-area` | `name` | `reviewed-no-change` |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `night_skiing.availability` | `changed` | The official page documents lift-served floodlit skiing at A9 Unterschwarzach. |
| `ski_area:saalbach-hinterglemm-ski-area` | `night_skiing.season_label` | `changed` | The official page states that the floodlit slope returns in winter 2026/27. |
| `ski_area:saalbach-hinterglemm-ski-area` | `official_trail_map.season_label` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
| `ski_area:saalbach-hinterglemm-ski-area` | `official_trail_map.url` | `changed` | Official Skicircus interactive map and PDF-download page. |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.availability` | `changed` | The official destination describes legendary umbrella and snow bars connected to the ski day. |
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.intensity` | `changed` | The destination presents tremendous apres as a defining ingredient of a Skicircus holiday. |
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.season_label` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.availability` | `changed` | The official inventory presents multiple freestyle and snowpark venues. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.park_count` | `changed` | The official inventory names Freeride Park, Learn-to-Ride Park, Family Park U-Bahn, and NITRO Snowpark. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.season_label` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.availability` | `changed` | The official destination documents a large snowmaking network. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_basis` | `changed` | The publisher explicitly uses '90% of the pistes'. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_pct` | `changed` | The official article states that the network ensures coverage on 90% of the pistes. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.season_label` | `unresolved` | Official Skicircus sources were reviewed, but they did not establish this exact value for the modeled ski area; it remains unknown rather than being inferred. |
...
| `stay_base:saalbach-hinterglemm-saalbach` | `base_character.development_style` | `changed` | Official material describes a traditional ski village transformed into a modern, youthful international resort identity. |
| `stay_base:saalbach-hinterglemm-saalbach` | `base_character.local_pace` | `changed` | The official destination highlights pulsating events, bars, pubs, and clubs. |
| `stay_base:saalbach-hinterglemm-saalbach` | `base_type` | `changed` |  |
| `stay_base:saalbach-hinterglemm-saalbach` | `elevation_m` | `changed` | Official destination material gives the Glemmtal/Saalbach starting elevation as 1,003 m. |
| `stay_base:saalbach-hinterglemm-saalbach` | `latitude` | `changed` |  |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.availability` | `changed` | The official directory presents a dense village apres and nightlife inventory. |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.intensity` | `changed` | Saalbach Hinterglemm is officially positioned as a top winter destination known for tremendous apres and stylish nightlife. |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.season_label` | `unresolved` | Official Saalbach sources were reviewed, but they did not establish this exact stay-base value; it remains unknown rather than being inferred. |
...
| `trust_manifest:lift_pass_products:ski-alpin-card` | `field_source_refs` | `reviewed-no-change` |  |
...
| `ski_area:saalbach-hinterglemm-ski-area` | `marked_freeride_routes.availability` | [Skicircus ski resort](https://www.saalbach.com/en/winter/ski-resort) | `"available"` | The official ski-resort page explicitly describes numerous ski routes of different difficulties. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `night_skiing.availability` | [Floodlit slope A9 U-Bahn](https://www.saalbach.com/en/winter/activities/floodlit-slopes_a_1690) | `"available"` | The official page documents lift-served floodlit skiing at A9 Unterschwarzach. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `night_skiing.season_label` | [Floodlit slope A9 U-Bahn](https://www.saalbach.com/en/winter/activities/floodlit-slopes_a_1690) | `"2026/27"` | The official page states that the floodlit slope returns in winter 2026/27. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `official_trail_map.url` | [Skicircus piste map](https://www.saalbach.com/en/winter/ski-resort/piste-map) | `"https://www.saalbach.com/en/winter/ski-resort/piste-map"` | Official Skicircus interactive map and PDF-download page. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.availability` | [Saalbach nightlife and party locations](https://www.saalbach.com/en/service/gastronomy/nightlife) | `"available"` | The official destination describes legendary umbrella and snow bars connected to the ski day. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `ski_day_apres_profile.intensity` | [Saalbach nightlife and party locations](https://www.saalbach.com/en/service/gastronomy/nightlife) | `"destination_defining"` | The destination presents tremendous apres as a defining ingredient of a Skicircus holiday. | The identity-level official wording is mapped to destination_defining. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.availability` | [Skicircus freestyle and snowparks](https://www.saalbach.com/de/winter/aktivitaeten/snowparks) | `"available"` | The official inventory presents multiple freestyle and snowpark venues. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `snow_park.park_count` | [Skicircus freestyle and snowparks](https://www.saalbach.com/de/winter/aktivitaeten/snowparks) | `4` | The official inventory names Freeride Park, Learn-to-Ride Park, Family Park U-Bahn, and NITRO Snowpark. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.availability` | [Pure Snow in the Skicircus](https://www.saalbach.com/en/service/stories/pure-snow_m_123346) | `"available"` | The official destination documents a large snowmaking network. |  |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_basis` | [Pure Snow in the Skicircus](https://www.saalbach.com/en/service/stories/pure-snow_m_123346) | `"piste_length"` | The publisher explicitly uses '90% of the pistes'. | Piste-based publisher wording is normalized to piste_length. |
| `ski_area:saalbach-hinterglemm-ski-area` | `snowmaking.coverage_pct` | [Pure Snow in the Skicircus](https://www.saalbach.com/en/service/stories/pure-snow_m_123346) | `90` | The official article states that the network ensures coverage on 90% of the pistes. | The publisher's whole-number percentage is stored as the catalog's numeric percentage type. |
| `stay_base:saalbach-hinterglemm-saalbach` | `base_character.development_style` | [Saalbach Home of Lassig identity](https://www.saalbach.com/en/service/stories/home-of-lassig-to-go_m_355429) | `"mixed"` | Official material describes a traditional ski village transformed into a modern, youthful international resort identity. | The explicit traditional-to-modern combination is mapped to mixed. |
| `stay_base:saalbach-hinterglemm-saalbach` | `base_character.local_pace` | [Saalbach nightlife and party locations](https://www.saalbach.com/en/service/gastronomy/nightlife) | `"lively"` | The official destination highlights pulsating events, bars, pubs, and clubs. | The event and nightlife breadth is mapped to lively. |
| `stay_base:saalbach-hinterglemm-saalbach` | `elevation_m` | [Glemmtal elevation and forestry](https://www.saalbach.com/en/service/stories/of-logging-and-lumberjacks_m_363978) | `1003` | Official destination material gives the Glemmtal/Saalbach starting elevation as 1,003 m. |  |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.availability` | [Saalbach nightlife and party locations](https://www.saalbach.com/en/service/gastronomy/nightlife) | `"available"` | The official directory presents a dense village apres and nightlife inventory. |  |
| `stay_base:saalbach-hinterglemm-saalbach` | `local_apres_profile.intensity` | [Saalbach nightlife and party locations](https://www.saalbach.com/en/service/gastronomy/nightlife) | `"destination_defining"` | Saalbach Hinterglemm is officially positioned as a top winter destination known for tremendous apres and stylish nightlife. | The identity-level prominence is mapped to destination_defining. |
...
- Source-aware v2 enrichment follow-up: The official snowmaking article explicitly states 90% of pistes, supporting a piste-length coverage basis.
- Source-aware v2 enrichment follow-up: The official ski-resort page confirms numerous ski routes but does not publish a complete count in the reviewed material.
- Source-aware v2 enrichment follow-up: The four-park count follows the destination's official Freestyle and Snowparks inventory: Freeride Park, Learn-to-Ride Park, Family Park U-Bahn, and NITRO Snowpark.
