...
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `full` | all canonical fields |
...
| `stay_base:le-chable-le-chable` | `full` | all canonical fields |
...
| `stay_destination:le-chable` | `full` | all canonical fields |
...
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `full` | all canonical fields |
...
| `trust_manifest:stay_bases:le-chable-le-chable` | `full` | all canonical fields |
...
| `trust_manifest:stay_destinations:le-chable` | `full` | all canonical fields |
...
| `le-chable` (Le Châble) | `stay_destination` | `add_entity` | `independent_stay_market`, `direct_access_relationship` | `stay_destination:le-chable` | `boundary-le-chable` |  | Le Châble is a named bookable market with its own access and materially different recommendation context. |
| `le-chable-base` (Le Châble village base) | `stay_base` | `add_entity` | `independent_stay_market`, `direct_access_relationship` | `stay_base:le-chable-le-chable` | `boundary-le-chable` |  | The named village is the representative base for Le Châble. |
| `le-chable-access` (Le Châble to Verbier-sector access) | `ski_area_access` | `add_entity` | `direct_access_relationship`, `distinct_access` | `ski_area_access:le-chable-le-chable--verbier-ski-area` | `boundary-le-chable` |  | A source-backed edge connects Le Châble to the shared Verbier sector. |
...
| --- | --- | --- | --- | --- | --- |
| `lift_pass_product:verbier-4-vallees-pass` | `available_from_stay_destination_ids` | `null` | `["bruson", "la-tzoumaz", "le-chable", "verbier"]` | `verified_with_adjustment` | no |
...
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `access_mode` | `null` | `"walk"` | `verified_with_adjustment` | yes |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `distance_m` | `null` | `230` | `verified_with_adjustment` | yes |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `is_direct` | `null` | `true` | `verified_with_adjustment` | yes |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `lift_distance` | `null` | `"near"` | `verified_with_adjustment` | yes |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `nearest_lift_name` | `null` | `"Gare du Châble gondola hub"` | `verified` | no |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `regional_data_ids` | `null` | `{"nearest_lift_osm_way_id": "25789997", "stay_base_osm_node_id": "304014579"}` | `verified_with_adjustment` | no |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `ski_area_access_id` | `null` | `"le-chable-le-chable--verbier-ski-area"` | `verified` | no |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `ski_area_id` | `null` | `"verbier-ski-area"` | `verified` | no |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `source_urls` | `null` | `["https://www.openstreetmap.org/node/304014579", "https://www.openstreetmap.org/way/25789997", "https://www.verbier.ch/en/destination/le-chable/"]` | `verified_with_adjustment` | no |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `stay_base_id` | `null` | `"le-chable-le-chable"` | `verified` | no |
...
| `stay_base:le-chable-le-chable` | `base_character.development_style` | `null` | `"traditional"` | `verified_with_adjustment` | no |
| `stay_base:le-chable-le-chable` | `base_character.local_pace` | `null` | `"quiet"` | `verified_with_adjustment` | no |
| `stay_base:le-chable-le-chable` | `base_type` | `null` | `"village"` | `verified` | no |
| `stay_base:le-chable-le-chable` | `elevation_m` | `null` | `821` | `verified` | no |
| `stay_base:le-chable-le-chable` | `latitude` | `null` | `46.0801462` | `verified_with_adjustment` | no |
| `stay_base:le-chable-le-chable` | `local_apres_profile.availability` | `null` | `"unknown"` | `needs_source` | no |
| `stay_base:le-chable-le-chable` | `longitude` | `null` | `7.2125027` | `verified_with_adjustment` | no |
| `stay_base:le-chable-le-chable` | `name` | `null` | `"Le Châble"` | `verified` | no |
| `stay_base:le-chable-le-chable` | `price_max` | `null` | `220.0` | `estimated` | yes |
| `stay_base:le-chable-le-chable` | `price_min` | `null` | `140.0` | `estimated` | yes |
| `stay_base:le-chable-le-chable` | `price_range` | `null` | `"EUR 140-220"` | `estimated` | yes |
| `stay_base:le-chable-le-chable` | `quality` | `null` | `"standard"` | `estimated` | yes |
| `stay_base:le-chable-le-chable` | `regional_data_ids` | `null` | `{"osm_node_id": "304014579"}` | `verified_with_adjustment` | no |
| `stay_base:le-chable-le-chable` | `stay_base_id` | `null` | `"le-chable-le-chable"` | `verified` | no |
| `stay_base:le-chable-le-chable` | `stay_destination_id` | `null` | `"le-chable"` | `verified_with_adjustment` | no |
...
| `stay_destination:le-chable` | `country` | `null` | `"Switzerland"` | `verified` | no |
| `stay_destination:le-chable` | `latitude` | `null` | `46.0801462` | `verified_with_adjustment` | yes |
| `stay_destination:le-chable` | `longitude` | `null` | `7.2125027` | `verified_with_adjustment` | yes |
| `stay_destination:le-chable` | `name` | `null` | `"Le Châble"` | `verified` | no |
| `stay_destination:le-chable` | `price_level` | `null` | `"medium"` | `estimated` | yes |
| `stay_destination:le-chable` | `region` | `null` | `"Valais"` | `verified` | no |
| `stay_destination:le-chable` | `regional_data_ids` | `null` | `{"osm_node_id": "304014579"}` | `verified_with_adjustment` | no |
| `stay_destination:le-chable` | `stay_destination_id` | `null` | `"le-chable"` | `verified` | no |
| `stay_destination:le-chable` | `trip_market_region_id` | `null` | `"verbier"` | `verified_with_adjustment` | no |
| `trust_manifest:lift_pass_products:verbier-4-vallees-pass` | `display_name` | `null` | `"4 Vallées ski pass"` | `estimated` | no |
| `trust_manifest:lift_pass_products:verbier-4-vallees-pass` | `field_source_refs` | `null` | `{"coverage": ["https://verbier4vallees.ch/en/ski-resort", "https://verbier4vallees.ch/en/ski-resort/4-vallees"], "identity_scope_availability": ["https://verbier4vallees.ch/en/ski-resort/4-vallees", "https://verbier4vallees.ch/en/useful-information/prices-winter", "https://www.verbier.ch/en/destination/le-chable/"], "pass_accessible_terrain": [], "prices": ["https://www.verbier.com/ski-passes"]}` | `estimated` | no |
...
| `trust_manifest:lift_pass_products:verbier-4-vallees-pass` | `notes` | `null` | `["Official operator sources establish the 4 Vallées product identity, availability, and network scope; the modeled coverage currently resolves only the Verbier sector.", "Le Châble is an official accommodation and gondola-access market for the modeled Verbier sector, so the pass is available there without changing its terrain coverage.", "The static 2025/26 adult 1-, 3-, and 6-day cash-desk examples come from the reviewed commercial Verbier.com tariff table, not from a first-party operator tariff artifact.", "Nendaz, Veysonnaz, Thyon, and the connected 4 Vallées terrain domain remain explicit catalog-curation backlog work."]` | `estimated` | no |
...
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `display_name` | `null` | `"Le Châble -> Verbier sector"` | `estimated` | no |
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `field_source_refs` | `null` | `{"access_mode_distance": ["https://www.openstreetmap.org/node/304014579", "https://www.openstreetmap.org/way/25789997", "https://www.verbier.ch/en/destination/le-chable/"], "relationship": ["https://www.openstreetmap.org/node/304014579", "https://www.openstreetmap.org/way/25789997", "https://www.verbier.ch/en/destination/le-chable/"]}` | `estimated` | no |
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `field_statuses` | `null` | `{"access_mode_distance": "verified_with_adjustment", "relationship": "verified"}` | `estimated` | no |
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `notes` | `null` | `["Official tourism identifies Le Châble as the lower-valley gondola gateway directly connected to both Verbier and Bruson.", "The 230 m distance is a rounded Haversine calculation from the OSM Le Châble village node to the Gare du Châble gondola-station way centre."]` | `estimated` | no |
...
| `trust_manifest:ski_regions:verbier` | `field_source_refs` | `{"identity": [], "membership_context": []}` | `{"identity": ["https://www.verbier.ch/en/destination/verbier/"], "membership_context": ["https://www.verbier.ch/en/destination/bruson/", "https://www.verbier.ch/en/destination/la-tzoumaz/", "https://www.verbier.ch/en/destination/le-chable/", "https://www.verbier.ch/en/destination/verbier/"]}` | `estimated` | no |
...
| `trust_manifest:ski_regions:verbier` | `notes` | `["Trust-contract first pass; not a full official-source recuration.", "Price, quality, lift-distance, skill, and rental fields are product-curated estimates until source-backed enrichment lands.", "Trip-market membership is retained as reviewed migration context and remains estimated.", "Legacy source-backed status was downgraded to needs_source because no direct external evidence remained for this owner."]` | `["The Verbier trip market groups four distinct official accommodation destinations accessing the jointly published Verbier ski sector: Verbier, La Tzoumaz, Bruson, and Le Châble.", "Nendaz, Veysonnaz, and Thyon remain independent future trip markets under a deferred 4 Vallees regional-network parent."]` | `estimated` | no |
...
| `trust_manifest:stay_bases:le-chable-le-chable` | `display_name` | `null` | `"Le Châble"` | `estimated` | no |
| `trust_manifest:stay_bases:le-chable-le-chable` | `field_source_refs` | `null` | `{"base_character": ["https://www.verbier.ch/en/destination/le-chable/"], "base_type": ["https://www.openstreetmap.org/node/304014579", "https://www.verbier.ch/en/destination/le-chable/"], "coordinates": ["https://www.openstreetmap.org/node/304014579"], "elevation": ["https://www.verbier.ch/app/uploads/ot-verbier/2024/11/Verbier_PocketGuide_Hivers_241024-10-bd.pdf"], "identity_ownership": ["https://www.openstreetmap.org/node/304014579", "https://www.verbier.ch/en/destination/le-chable/"], "local_apres": [], "lodging_price_quality": ["https://www.verbier.ch/en/destination/le-chable/"]}` | `estimated` | no |
| `trust_manifest:stay_bases:le-chable-le-chable` | `field_statuses` | `null` | `{"base_character": "verified_with_adjustment", "base_type": "verified", "coordinates": "verified", "elevation": "verified", "identity_ownership": "verified", "local_apres": "needs_source", "lodging_price_quality": "estimated"}` | `estimated` | no |
| `trust_manifest:stay_bases:le-chable-le-chable` | `notes` | `null` | `["Official tourism describes Le Châble as a peaceful traditional village and major service hub rather than merely a transit point; Snowcast normalizes that to traditional development and a quiet local pace.", "The official winter pocket guide labels Le Châble at 821 m.", "Lodging price and quality remain product-curated estimates pending a reviewed accommodation sampling policy; a recurring base-local apres profile was not established."]` | `estimated` | no |
...
| `trust_manifest:stay_destinations:le-chable` | `display_name` | `null` | `"Le Châble"` | `estimated` | no |
| `trust_manifest:stay_destinations:le-chable` | `field_source_refs` | `null` | `{"coordinates": ["https://www.openstreetmap.org/node/304014579"], "identity_location": ["https://www.verbier.ch/en/destination/le-chable/"], "price_level": ["https://www.verbier.ch/en/destination/le-chable/"]}` | `estimated` | no |
| `trust_manifest:stay_destinations:le-chable` | `field_statuses` | `null` | `{"coordinates": "verified", "identity_location": "verified", "price_level": "estimated"}` | `estimated` | no |
| `trust_manifest:stay_destinations:le-chable` | `notes` | `null` | `["Official tourism presents Le Châble as a distinct bookable village and lower-valley gateway with direct gondola access to Verbier and Bruson.", "The medium price level is a product-curated estimate pending a reviewed accommodation sampling policy."]` | `estimated` | no |
...
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `access_mode` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `distance_m` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `duration_minutes` | `reviewed-no-change` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `is_direct` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `lift_distance` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `nearest_lift_name` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `regional_data_ids` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `ski_area_access_id` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `ski_area_id` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `source_urls` | `changed` |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `stay_base_id` | `changed` |  |
...
| `stay_base:le-chable-le-chable` | `base_character.development_style` | `changed` |  |
| `stay_base:le-chable-le-chable` | `base_character.local_pace` | `changed` |  |
| `stay_base:le-chable-le-chable` | `base_type` | `changed` |  |
| `stay_base:le-chable-le-chable` | `elevation_m` | `changed` |  |
| `stay_base:le-chable-le-chable` | `latitude` | `changed` |  |
| `stay_base:le-chable-le-chable` | `local_apres_profile.availability` | `changed` |  |
| `stay_base:le-chable-le-chable` | `local_apres_profile.intensity` | `unresolved` | No recurring base-local apres profile was established for this new stay base. |
| `stay_base:le-chable-le-chable` | `local_apres_profile.season_label` | `unresolved` | No recurring base-local apres profile was established for this new stay base. |
| `stay_base:le-chable-le-chable` | `longitude` | `changed` |  |
| `stay_base:le-chable-le-chable` | `name` | `changed` |  |
| `stay_base:le-chable-le-chable` | `price_max` | `changed` |  |
| `stay_base:le-chable-le-chable` | `price_min` | `changed` |  |
| `stay_base:le-chable-le-chable` | `price_range` | `changed` |  |
| `stay_base:le-chable-le-chable` | `quality` | `changed` |  |
| `stay_base:le-chable-le-chable` | `regional_data_ids` | `changed` |  |
| `stay_base:le-chable-le-chable` | `stay_base_id` | `changed` |  |
| `stay_base:le-chable-le-chable` | `stay_destination_id` | `changed` |  |
...
| `stay_destination:le-chable` | `country` | `changed` |  |
| `stay_destination:le-chable` | `latitude` | `changed` |  |
| `stay_destination:le-chable` | `longitude` | `changed` |  |
| `stay_destination:le-chable` | `name` | `changed` |  |
| `stay_destination:le-chable` | `price_level` | `changed` |  |
| `stay_destination:le-chable` | `region` | `changed` |  |
| `stay_destination:le-chable` | `regional_data_ids` | `changed` |  |
| `stay_destination:le-chable` | `stay_destination_id` | `changed` |  |
| `stay_destination:le-chable` | `trip_market_region_id` | `changed` |  |
...
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `display_name` | `changed` |  |
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `field_source_refs` | `changed` |  |
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `field_statuses` | `changed` |  |
| `trust_manifest:ski_area_access:le-chable-le-chable--verbier-ski-area` | `notes` | `changed` |  |
...
| `trust_manifest:stay_bases:le-chable-le-chable` | `display_name` | `changed` |  |
| `trust_manifest:stay_bases:le-chable-le-chable` | `field_source_refs` | `changed` |  |
| `trust_manifest:stay_bases:le-chable-le-chable` | `field_statuses` | `changed` |  |
| `trust_manifest:stay_bases:le-chable-le-chable` | `notes` | `changed` |  |
...
| `trust_manifest:stay_destinations:le-chable` | `display_name` | `changed` |  |
| `trust_manifest:stay_destinations:le-chable` | `field_source_refs` | `changed` |  |
| `trust_manifest:stay_destinations:le-chable` | `field_statuses` | `changed` |  |
| `trust_manifest:stay_destinations:le-chable` | `notes` | `changed` |  |
...
| --- | --- | --- | --- | --- | --- |
| `lift_pass_product:verbier-4-vallees-pass` | `available_from_stay_destination_ids` | [Official Le Châble destination and ski access](https://www.verbier.ch/en/destination/le-chable/) | `["bruson", "la-tzoumaz", "le-chable", "verbier"]` | Official tourism presents Le Châble as a bookable base with direct gondolas to Verbier and Bruson and access to the 4 Vallées ski offer. | The source fact is normalized to Snowcast's available_from_stay_destination_ids representation and scoped to lift_pass_product:verbier-4-vallees-pass. |
...
| `ski_area:verbier-ski-area` | `ski_day_apres_profile.availability` | [Official Verbier sector profile](https://verbier4vallees.ch/en/ski-resort/verbier) | `"available"` | The operator calls Verbier's after-ski scene legendary and describes dancing and sampling local specialities while still wearing ski gear. | The source fact is normalized to Snowcast's ski_day_apres_profile.availability representation and scoped to ski_area:verbier-ski-area. |
| `ski_area:verbier-ski-area` | `ski_day_apres_profile.intensity` | [Official Verbier sector profile](https://verbier4vallees.ch/en/ski-resort/verbier) | `"destination_defining"` | The operator calls Verbier's after-ski scene legendary and describes dancing and sampling local specialities while still wearing ski gear. | The source fact is normalized to Snowcast's ski_day_apres_profile.intensity representation and scoped to ski_area:verbier-ski-area. |
...
| `ski_area:verbier-ski-area` | `supported_skill_levels` | [Official Verbier sector profile](https://verbier4vallees.ch/en/ski-resort/verbier) | `["beginner", "intermediate", "advanced"]` | The operator describes Verbier as offering runs at all difficulty levels. | The source fact is normalized to Snowcast's supported_skill_levels representation and scoped to ski_area:verbier-ski-area. |
...
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `access_mode` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `"walk"` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. | The source fact is normalized to Snowcast's access_mode representation and scoped to ski_area_access:le-chable-le-chable--verbier-ski-area. |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `distance_m` | [OpenStreetMap Gare du Châble gondola station](https://www.openstreetmap.org/way/25789997) | `230` | Open data locates Le Châble village and its gondola hub about 230 metres apart. | The source fact is normalized to Snowcast's distance_m representation and scoped to ski_area_access:le-chable-le-chable--verbier-ski-area. |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `is_direct` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `true` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. | The source fact is normalized to Snowcast's is_direct representation and scoped to ski_area_access:le-chable-le-chable--verbier-ski-area. |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `lift_distance` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `"near"` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. | The source fact is normalized to Snowcast's lift_distance representation and scoped to ski_area_access:le-chable-le-chable--verbier-ski-area. |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `nearest_lift_name` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `"Gare du Châble gondola hub"` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `regional_data_ids` | [OpenStreetMap Gare du Châble gondola station](https://www.openstreetmap.org/way/25789997) | `{"nearest_lift_osm_way_id": "25789997", "stay_base_osm_node_id": "304014579"}` | Open data locates Le Châble village and its gondola hub about 230 metres apart. | The source fact is normalized to Snowcast's regional_data_ids representation and scoped to ski_area_access:le-chable-le-chable--verbier-ski-area. |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `ski_area_access_id` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `"le-chable-le-chable--verbier-ski-area"` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `ski_area_id` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `"verbier-ski-area"` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. |  |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `source_urls` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `["https://www.openstreetmap.org/node/304014579", "https://www.openstreetmap.org/way/25789997", "https://www.verbier.ch/en/destination/le-chable/"]` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. | The source fact is normalized to Snowcast's source_urls representation and scoped to ski_area_access:le-chable-le-chable--verbier-ski-area. |
| `ski_area_access:le-chable-le-chable--verbier-ski-area` | `stay_base_id` | [Official Le Châble destination access](https://www.verbier.ch/en/destination/le-chable/) | `"le-chable-le-chable"` | Official tourism identifies Le Châble as the gondola gateway directly connected to Verbier and Bruson. |  |
...
| `stay_base:bruson-bruson` | `elevation_m` | [Official bruson-bruson elevation context](https://www.verbier.ch/app/uploads/ot-verbier/2024/11/Verbier_PocketGuide_Hivers_241024-10-bd.pdf) | `1080` | Official destination or operator material establishes the representative village elevation used by Snowcast. |  |
...
| `stay_base:le-chable-le-chable` | `base_character.development_style` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"traditional"` | Official tourism establishes the named village, its accommodation context, and its published character. | The source fact is normalized to Snowcast's base_character.development_style representation and scoped to stay_base:le-chable-le-chable. |
| `stay_base:le-chable-le-chable` | `base_character.local_pace` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"quiet"` | Official tourism establishes the named village, its accommodation context, and its published character. | The source fact is normalized to Snowcast's base_character.local_pace representation and scoped to stay_base:le-chable-le-chable. |
| `stay_base:le-chable-le-chable` | `base_type` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"village"` | Official tourism establishes the named village, its accommodation context, and its published character. |  |
| `stay_base:le-chable-le-chable` | `elevation_m` | [Official le-chable-le-chable elevation context](https://www.verbier.ch/app/uploads/ot-verbier/2024/11/Verbier_PocketGuide_Hivers_241024-10-bd.pdf) | `821` | Official destination or operator material establishes the representative village elevation used by Snowcast. |  |
| `stay_base:le-chable-le-chable` | `latitude` | [OpenStreetMap le-chable-le-chable place record](https://www.openstreetmap.org/node/304014579) | `46.0801462` | Open data supplies the normalized stay-base reference point and regional ID. | The source fact is normalized to Snowcast's latitude representation and scoped to stay_base:le-chable-le-chable. |
| `stay_base:le-chable-le-chable` | `longitude` | [OpenStreetMap le-chable-le-chable place record](https://www.openstreetmap.org/node/304014579) | `7.2125027` | Open data supplies the normalized stay-base reference point and regional ID. | The source fact is normalized to Snowcast's longitude representation and scoped to stay_base:le-chable-le-chable. |
| `stay_base:le-chable-le-chable` | `name` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"Le Châble"` | Official tourism establishes the named village, its accommodation context, and its published character. |  |
| `stay_base:le-chable-le-chable` | `price_max` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `220.0` | Official tourism establishes the named village, its accommodation context, and its published character. | This is a product-curated estimate; the source establishes the accommodation context but not the exact value. |
| `stay_base:le-chable-le-chable` | `price_min` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `140.0` | Official tourism establishes the named village, its accommodation context, and its published character. | This is a product-curated estimate; the source establishes the accommodation context but not the exact value. |
| `stay_base:le-chable-le-chable` | `price_range` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"EUR 140-220"` | Official tourism establishes the named village, its accommodation context, and its published character. | This is a product-curated estimate; the source establishes the accommodation context but not the exact value. |
| `stay_base:le-chable-le-chable` | `quality` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"standard"` | Official tourism establishes the named village, its accommodation context, and its published character. | This is a product-curated estimate; the source establishes the accommodation context but not the exact value. |
| `stay_base:le-chable-le-chable` | `regional_data_ids` | [OpenStreetMap le-chable-le-chable place record](https://www.openstreetmap.org/node/304014579) | `{"osm_node_id": "304014579"}` | Open data supplies the normalized stay-base reference point and regional ID. | The source fact is normalized to Snowcast's regional_data_ids representation and scoped to stay_base:le-chable-le-chable. |
| `stay_base:le-chable-le-chable` | `stay_base_id` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"le-chable-le-chable"` | Official tourism establishes the named village, its accommodation context, and its published character. |  |
| `stay_base:le-chable-le-chable` | `stay_destination_id` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"le-chable"` | Official tourism establishes the named village, its accommodation context, and its published character. | The source fact is normalized to Snowcast's stay_destination_id representation and scoped to stay_base:le-chable-le-chable. |
...
| `stay_destination:le-chable` | `country` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"Switzerland"` | Official tourism treats this place as a named, bookable accommodation destination with its own recommendation context. |  |
| `stay_destination:le-chable` | `latitude` | [OpenStreetMap le-chable place record](https://www.openstreetmap.org/node/304014579) | `46.0801462` | Open data supplies the normalized destination reference point and regional ID. | The source fact is normalized to Snowcast's latitude representation and scoped to stay_destination:le-chable. |
| `stay_destination:le-chable` | `longitude` | [OpenStreetMap le-chable place record](https://www.openstreetmap.org/node/304014579) | `7.2125027` | Open data supplies the normalized destination reference point and regional ID. | The source fact is normalized to Snowcast's longitude representation and scoped to stay_destination:le-chable. |
| `stay_destination:le-chable` | `name` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"Le Châble"` | Official tourism treats this place as a named, bookable accommodation destination with its own recommendation context. |  |
| `stay_destination:le-chable` | `price_level` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"medium"` | Official tourism treats this place as a named, bookable accommodation destination with its own recommendation context. | This is a product-curated estimate; the source establishes the accommodation context but not the exact value. |
| `stay_destination:le-chable` | `region` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"Valais"` | Official tourism treats this place as a named, bookable accommodation destination with its own recommendation context. |  |
| `stay_destination:le-chable` | `regional_data_ids` | [OpenStreetMap le-chable place record](https://www.openstreetmap.org/node/304014579) | `{"osm_node_id": "304014579"}` | Open data supplies the normalized destination reference point and regional ID. | The source fact is normalized to Snowcast's regional_data_ids representation and scoped to stay_destination:le-chable. |
| `stay_destination:le-chable` | `stay_destination_id` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"le-chable"` | Official tourism treats this place as a named, bookable accommodation destination with its own recommendation context. |  |
| `stay_destination:le-chable` | `trip_market_region_id` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `"verbier"` | Official tourism treats this place as a named, bookable accommodation destination with its own recommendation context. | The source fact is normalized to Snowcast's trip_market_region_id representation and scoped to stay_destination:le-chable. |
...
| `stay_destination:le-chable` | `name` | [Official Le Châble destination profile](https://www.verbier.ch/en/destination/le-chable/) | `{"bookable": true, "destination": "le-chable", "distinct_access": true, "distinct_recommendation_context": true}` | Le Châble has its own accommodation inventory, traditional lower-valley character, rail arrival context, and direct gondolas to Verbier and Bruson. | The source's destination treatment is evaluated through Snowcast's three stay-destination boundary gates. |
...
Candidate generation can now represent Verbier, La Tzoumaz, Bruson, and Le Châble as distinct stay configurations against one correctly scoped ski-area owner; no runtime policy is changed by this curation.
...
- La Tzoumaz, Bruson, and Le Châble lodging price ranges and quality tiers remain product-curated estimates, and no recurring base-local apres profile was established for these villages.
- The owner explicitly approved completing the four-destination Verbier trip market in this PR as a focused exception to the normal three-destination curation batch guideline.
